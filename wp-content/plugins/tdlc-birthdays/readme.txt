...
1. [BUG] Fixed Error when show profile link not set.

*1.0.1*

* 06/10/2018

1. [BUG] Fixed show age setting removal error.
2. [BUG] Fixed show link setting removal error.
3. [ENH] Added NL language translation, thanks to jdekkers


*1.0.0*

1. [BUG] Fixed missing serveroffset variable
2. [BUG] Fixed Follow variable problem
3. [BUG] Fixed deprecated class constructor issue.
4. [BUG] Fixed deprecated Widget constructor issue.
5. [BUG] Corrected function names 
6. [UPDATE] New plugin owner, details updated.
